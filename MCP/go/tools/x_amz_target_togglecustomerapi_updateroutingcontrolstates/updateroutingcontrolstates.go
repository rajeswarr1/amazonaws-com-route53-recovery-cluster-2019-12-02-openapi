...
func UpdateroutingcontrolstatesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateRoutingControlStatesRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=ToggleCustomerAPI.UpdateRoutingControlStates", cfg.BaseURL)
		...
		var result models.UpdateRoutingControlStatesResponse
