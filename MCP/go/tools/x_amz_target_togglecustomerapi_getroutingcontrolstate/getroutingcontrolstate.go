...
func GetroutingcontrolstateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetRoutingControlStateRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=ToggleCustomerAPI.GetRoutingControlState", cfg.BaseURL)
		...
		var result models.GetRoutingControlStateResponse
...
func CreateGetroutingcontrolstateTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetroutingcontrolstateHandler(cfg),
	}
}
